package de.aittr.g_27_security.config;
  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    http
        ...
        .authorizeHttpRequests(
            x -> x
                .requestMatchers(HttpMethod.POST,"/register/newUser").permitAll()
                ...
                .requestMatchers(HttpMethod.POST,"/admin/promote/{userId}").permitAll()
